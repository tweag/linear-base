...
singleton elem = Vec (1,defaultSize) (unsafeNewMutArr defaultSize elem)
...
write = Linear.toLinear writeUnsafe
  where
    ...
    writeUnsafe v@(Vec (len, size) mutArr) ix val

...
-- Note that this does throw an exception and that there's a reasonable
-- coherent view and method to using exceptions in Haskell!
-- See https://www.tweag.io/posts/2020-04-16-exceptions-in-haskell.html.
alloc :: HasCallStack =>
...
instance Consumable (Array a) where
  consume :: Array a #-> ()
  consume (!arr) = (Unsafe.toLinear (\_ -> ())) arr
